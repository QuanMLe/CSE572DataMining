...
for i = 1 : size(userNums, 1)
    ...
    % Users_Fork_Eat_Data for later use in the SVD function
...
% Saves the data before calling SVD function
...
[U,S,V] = svd(Users_Fork_Eat_Data);
Users_Fork_Eat_Coeffs = V;

[U,S,V] = svd(Users_Fork_NotEat_Data);
Users_Fork_NotEat_Coeffs = V;

[U,S,V] = svd(Users_Spoon_Eat_Data);
Users_Spoon_Eat_Coeffs = V;

[U,S,V] = svd(Users_Spoon_NotEat_Data);
Users_Spoon_NotEat_Coeffs = V;
