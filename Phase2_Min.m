...
% Path where the Min files will be written out
outputPath = strcat(scriptPath,'\Phase_2_Data\Min');
mkdir(outputPath);
...
%Loop that runs through the files and gets the Min
...
display('Min has been calculated');